export function ThemeBtn() {
  ...
  return (
    <button
      onClick={toggleTheme}
      className="cursor-pointer rounded-full  block bg-gray-200 p-1 dark:bg-gray-700 text-gray-500 dark:text-gray-200"
      id="theme-btn"
      type="button"
    >
      <svg
        className="hidden dark:block bg-transparent size-8"
        aria-hidden="true"
        viewBox="0 0 24 24"
        fill="currentColor"
      >
      ...
      <svg
        className="block dark:hidden bg-transparent size-8"
        aria-hidden="true"
        viewBox="0 0 24 24"
        fill="currentColor"
      >
