...
export const myProjects: IProject[] = [
  {
    ...
    deploy: "vercel",
    image:
      "https://www.dropbox.com/scl/fi/m6vzt3tx6nuuhvkxgiyw3/clior.webp?rlkey=1ph4dond6v40m47ys5y0wlb4a&st=f6sn5xlr&raw=1",
    concepts: [
      "Authentication",
      "State management",
      "Code splitting",
      "Manage cookies",
      "UI libraries (flowbite)",
    ],
  },
  {
    ...
    deploy: "netlify",
    image:
      "https://www.dropbox.com/scl/fi/3vx4bw7gmkdpy3lzj4qe4/ubuntu.webp?rlkey=jnsbbqkxs74nn3wlq0wporkvg&st=pd1f8swy&raw=1",
    concepts: ["Angular signals", "Backend connection", "Directories organization", "Management library external"],
  },
  {
    title: "Retro Blog",
    description:
    ...
    deploy: "vercel",
    image:
      "https://www.dropbox.com/scl/fi/5469s60a6i7kkrh2snodt/retro-blog.webp?rlkey=y4fzo2u4d837l5ck6iraxqfyn&st=5z3k3hd8&raw=1",
    concepts: ["Scroll driven Animations", "SSG concepts", "Componentization", "Seo concepts"],
  },
  {
    title: "Text to Speech",
    description:
      "Desarrollado utilizando la programación Orientada a objetos (POO), cuenta un manejador de errores en caso no ser compatible.",
    links: {
    ...
    deploy: "vercel",
    image:
      "https://www.dropbox.com/scl/fi/e9malpqyvbfg9l7vr2ziq/text-to-speech.webp?rlkey=ure8t2dlw11mw1tpgsy9lzlum&st=qn26ra5i&raw=1",
    concepts: ["Programming Oriented to Objects", "Error handling"],
  },
];
